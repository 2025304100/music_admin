...
public class Resource {
    ...
    private static int cpuLoad() throws InterruptedException {
    ...
    //获取当时使用系统
    private static String isWindowsOrLinux() {
    ...
    private static Map<String, String> getNetworkThrough() {
    ...
    private static Map<String, String> getNetworkThroughputFor(String exi, String th) {
        Process pro1 = null;
