...
//        return String.toString(decoded);
//    }

    public static byte[] decode(String bo, String base64Encoded) throws UnsupportedEncodingException {
        byte[] bytes = base64Encoded.getBytes(bo);
        return decode(bytes);
    }
